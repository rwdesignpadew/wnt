...
class GoogleMapsViewFactory(
  ...
  private val activityContextProvider: () -> Context?,
) : PlatformViewFactory(ViewCreationApi.codec) {
  override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
    val viewContext = activityContextProvider() ?: context
    ...
    if (params.mapViewType == MapViewTypeDto.NAVIGATION) {
      ...
      return GoogleMapView(viewContext, mapOptions, viewId, viewEventApi, viewRegistry, imageRegistry)
    }
  }
}
